...
- [vite-vanilla-tailwind-v3](https://github.com/huibizhang/template-vite-vanilla-tailwind-v3) - Tailwindcss 的入门模板和内置的 prettier-plugin-tailwindcss。
- [vite-vanilla-ts-lib-starter](https://github.com/kbysiec/vite-vanilla-ts-lib-starter) - 入门库(CJS, ESM, IIFE)与TypeScript, ESLint, Stylelint, Prettier, Jest, Husky + lint-stage。
